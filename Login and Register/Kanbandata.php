...
<div class="sidebar">
  ...
  <ul class="nav-list">
    <li><a href="user.php"><i class='bx bx-user'></i><span class="links_name">User</span></a></li>
    <li><a href="dashboard.php"><i class='bx bx-grid-alt'></i><span class="links_name">Dashboard</span></a></li>
    <li><a href="tasklist.php"><i class='bx bx-task'></i><span class="links_name">Task List</span></a></li>
    <li><a href="pomo.php"><i class='bx bx-time'></i><span class="links_name">Pomodoro</span></a></li>
    <li><a href="calendario.php"><i class='bx bx-calendar-check'></i><span class="links_name">Calendar</span></a></li>
    <li><a href="To-Do.php"><i class='bx bx-note'></i><span class="links_name">To-Do List</span></a></li>
    <li><a href="kanbanlist.php"><i class='bx bx-notepad'></i><span class="links_name">Kanban</span></a></li>
    <li class="profile">
...
<section class="home-section">
  <div class="text">Kanban List</div>
  <main class="table" id="customers_table">
    <section class="table__header">
        <h1>Kanban Task List</h1>
    ...
    <section class="table__body" id="UserName">
        <table>
            ...
            foreach ($result as $row) {
                // Accediendo a los datos de cada fila
