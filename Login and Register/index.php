    ...
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-8 col-lg-7 col-xl-6">
          <img src="log.svg" class="img-fluid" alt="foto de iniciar sesion" height="300px" width="600px">
        </div>
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="login.php" method="post">
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              <input type="submit" value="Sign in" name="login" class="btn btn-primary blue btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" />
            </div>

          </form><br>
          <p align="center">i don't have any account? <a href="register.php" class="text-blue" style="font-weight:600;text-decoration:none;">Register Here</a></p>
          <p align="center">i am <a href="admin.php" class="text-blue" style="font-weight:600;text-decoration:none;">admin</a></p>
        </div>
      </div>
    </div>
  </section>
