            ...
            <div class="card-body p-md-2">
              ...
              <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Sign up</p>
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="./Controller/add.php" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Register" name="register" class="btn btn-primary blue btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" style="border-radius:25px ;" />

                    </div>

                  </form>
                  <p align="center">i have already account <a href="index.php" class="text-blue" style="font-weight:600; text-decoration:none;">Login</a></p>
